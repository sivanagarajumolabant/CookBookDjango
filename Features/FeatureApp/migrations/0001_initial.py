# Generated by Django 3.2.11 on 2022-02-22 10:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('can_view', models.TextField(default=[{'Label': 'Procedures', 'subMenu': []}, {'Label': 'Functions', 'subMenu': []}, {'Label': 'Packages', 'subMenu': []}, {'Label': 'Indexes', 'subMenu': []}, {'Label': 'Materialized views', 'subMenu': []}, {'Label': 'Sequences', 'subMenu': []}, {'Label': 'Synonyms', 'subMenu': []}, {'Label': 'Tabels', 'subMenu': []}, {'Label': 'Triggers', 'subMenu': []}, {'Label': 'Types', 'subMenu': []}, {'Label': 'Views', 'subMenu': []}])),
