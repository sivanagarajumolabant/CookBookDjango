    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AttachmentType', models.FileField(blank=True, choices=[('Sourcedescription', 'sourcedescription'), ('Targetdescription', 'targetdescription'), ('Conversion', 'conversion')], null=True, upload_to='media/')),
